...
class info(commands.Cog, name="Информация"):
    ...
    async def _bot(self, ctx):
        ...
        emb.add_field(name="Создатель:",value=self.client.get_user(690496049361584159).mention)
        emb.add_field(name="Разработчик(и):",
        value=f"{self.client.get_user(511508551492173836).mention}, {self.client.get_user(361156000155172865).mention}")
